        ...
        <LayoutDashboard>
            <div className="w-full grid grid-cols-1 gap-4 min-h-screen">
                <div className="bg-white min-w-full shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div className="mb-4">
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">List Tokoh Masyarakat</h3>
                            <span className="text-base font-normal text-gray-500">Berikut merupakan list Tokoh Masyarakat</span>
                        </div>
                    </div>
