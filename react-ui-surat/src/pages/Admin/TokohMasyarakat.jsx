...
const TokohMasyarakat = () => {
    ...
    const [tokohMasyarakat, settokohMasyarakat] = useState({
        nama: "",
        tanggal_lahir: "",
        alamat: "",
        rt: "",
    ...
    const onInputEditChange = (e) => {
        settokohMasyarakat({ ...tokohMasyarakat, [e.target.name]: e.target.value })
    }
    ...
    const onSaveEdit = async () => {
        const dataSaveEdit = {
            ...
            nomor_sk: tokohMasyarakat.nomor_sk.toString(),
            tanggal_sk: tokohMasyarakat.tanggal_sk.toString(),
            tanggal_akhir_sk: tokohMasyarakat.tanggal_akhir_sk.toString(),
            keterangan: tokohMasyarakat.keterangan,
            photo: tokohMasyarakat.photo,
        }

        console.log(dataSaveEdit)

        await axios.put(`http://localhost:8000/api/v1/pegawai/${tokohMasyarakat?.nik}`, dataSaveEdit, {
            headers: {
    ...
    const { data: tokohMasyarakats, error: errortokohMasyarakats } = useSWR(
        `http://localhost:8000/api/v1/pegawai/tokoh-masyarakat`,
        (url) =>
            axios(url, {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("xtoken"),
    ...
    if (errortokohMasyarakats) {
        swal({
            title: "Peringatan",
            text: errortokohMasyarakats.message,
            icon: "error",
            ...
            switch (value) {
                case "oke":
                    if (errortokohMasyarakats.status === 401) {
            ...
            <div className="w-full grid grid-cols-1 gap-4 min-h-screen">
                <div className="bg-white min-w-full shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                    <div className="mb-4 flex justify-between items-center">
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">List Pengurus Tokoh Masyarakat</h3>
                            <span className="text-base font-normal text-gray-500">Berikut merupakan list Pengurus Tokoh Masyarakat</span>
                        </div>
                        <div>
                                        ...
                                        <tbody className="bg-white">
                                            {
                                                ...
                                                ) : tokohMasyarakats?.results?.map((element, i) => (
                                                    <tr key={i}>
                ...
                {/* Modal Edit */}
                <DefaultModal
                    title={`Edit ${tokohMasyarakat?.nama}`}
                    open={openModal}
                    setOpen={handleModal}
                    onSubmit={onSaveEdit}
                >
                    ...
                    >
                        ...
                        <div className="mb-5">
                            <TextField
                                ...
                                className='mt-5'
                                onChange={(e) => onInputEditChange(e)}
                                value={tokohMasyarakat.tanggal_lahir}
                            />
                        </div>
                        <div className="mb-5">
                            <TextField
                        ...
                        <div className="mb-5">
                            <TextField
                                ...
                                className='mt-5'
                                onChange={(e) => onInputEditChange(e)}
                                value={parseInt(tokohMasyarakat.nomor_sk)}
                            />
                            ...
                            <TextField
                                ...
                                className='mt-5'
                                onChange={(e) => onInputEditChange(e)}
                                value={parseInt(tokohMasyarakat.tanggal_sk)}
                            />
                        </div> <div className="mb-5">
                            <TextField
                                fullWidth
                                ...
                                className='mt-5'
                                onChange={(e) => onInputEditChange(e)}
                                value={parseInt(tokohMasyarakat.tanggal_akhir_sk)}
                            />
                        </div>
                        <div className="mb-5">
                            <TextField
                                ...
                                className='mt-5'
                                onChange={(e) => onInputEditChange(e)}
                                value={tokohMasyarakat.keterangan}
                            />
                        </div>
                        <div className="mb-5">
                            <TextField
                ...
                {/* Modal Add Data */}
                <DefaultModal
                    title="Tambah Data Tokoh Masyarakat"
                    open={openAddModal}
                ...
                {/* Modal Delete */}
                <ModalDelete
                    data={tokohMasyarakat}
                    open={openDeleteModal}
                    setOpen={handleDeleteModal}
                    handleDelete={() => onDelete(tokohMasyarakat.nik)}
                />
            </div>
        </LayoutDashboard>
    )
...
export default TokohMasyarakat