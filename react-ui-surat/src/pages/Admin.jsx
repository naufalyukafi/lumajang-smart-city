...
const Admin = () => {
        ...
        axisY: {
            ...
            crosshair: {
                ...
                labelFormatter: function (e) {
                    return "€" + CanvasJSChart.formatNumber(e.value, "##0.00");
                }
            }
        },
        data: [{
    ...
    return (
        <>
            {/* Navbar */}
            <nav className={`${open} bg-white border-b border-gray-200 fixed z-30 w-full`}>
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            <button onClick={() => { setOpen(!open) }} aria-expanded="true" aria-controls="sidebar" className={`${!open}lg:hidden mr-2 text-gray-600 hover:text-gray-900 cursor-pointer p-2 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 rounded `}>
                        ...
                        <div className="flex items-center">
                            <div className="hidden laptop:flex items-center">
                                <div className="-mb-1">
                                    <a className="github-button" href="#admin_blank" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/windster-tailwind-css-dashboard on GitHub">User</a>
                                </div>
                            </div>
                            <a href="#admin_blank" className="hidden handphone:inline-flex ml-5 text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
                                Logout
                            </a>
                        </div>
                    </div>
            ...
            <div className="flex overflow-hidden bg-white pt-16">
                <aside id="sidebar" className={`${open}fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar`}>
                    <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
                        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                                <ul className="space-y-2 pb-2">
                                    <li>
                                        <form action="#admin" method="GET" className="lg:hidden">
                                    ...
                                    <li>
                                        <a href="#admin" className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                    ...
                                    <li>
                                        <a href="#admin" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <li>
                                        <a href="#admin" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                            <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="space-y-2 pt-2">
                                    <a href="#admin" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                    ...
                                    <a href="#admin" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                        <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                <main>
                    <div className="pt-6 px-4">
                        <div className="w-full grid grid-cols-1 laptop:grid-cols-2 gap-4">
                            <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                ...
                                <div id="main-chart">
                                    <p><CanvasJSChart options={options} /></p>
                                </div>
                            </div>
                    ...
                    {/* Footer */}
                    <footer className="bg-white laptop:flex laptop:items-center laptop:justify-between shadow rounded-lg p-4 laptop:p-6 my-6 mx-4">
                        <ul className="flex items-center flex-wrap mb-6 laptop:mb-0">
                            <li><a href="#admin" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Terms and conditions</a></li>
                            <li><a href="#admin" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Privacy Policy</a></li>
                            <li><a href="#admin" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Licensing</a></li>
                            <li><a href="#admin" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Cookie Policy</a></li>
                            <li><a href="#admin" className="text-sm font-normal text-gray-500 hover:underline">Contact</a></li>
                        </ul>
                        <div className="flex handphone:justify-center space-x-6">
                    ...
                    <p className="text-center text-sm text-gray-500 my-10">
                        &copy; 2022-2023 <a href="#admin" className="hover:underline" target="_blank">Lumajang Eksotik</a>. All rights reserved.
                    </p>
                </main>
            </div>
            {/* Akhir Content */}
